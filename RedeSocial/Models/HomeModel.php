	...
	class HomeModel{
		...
		public static function retrieveFriendsPosts(){
			...
			foreach ($amigosConfirmados as $key => $value) {
				$listaAmigos[$key]['id'] = \RedeSocial\Models\UsuariosModel::getUsuarioById($value)['id'];
				$listaAmigos[$key]['nome'] = \RedeSocial\Models\UsuariosModel::getUsuarioById($value)['nome'];
				$listaAmigos[$key]['email'] = \RedeSocial\Models\UsuariosModel::getUsuarioById($value)['email'];
				$listaAmigos[$key]['img'] = \RedeSocial\Models\UsuariosModel::getUsuarioById($value)['img'];
				$listaAmigos[$key]['ultimo_post'] = \RedeSocial\Models\UsuariosModel::getUsuarioById($value)['ultimo_post'];
			}
